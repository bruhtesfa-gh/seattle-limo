...
function Service() {
  ...
  useEffect(() => {
    ...
    getServices().then((res) => {
      setAllServices(res);
      setService(res.find((item: any) => item.id == slug));
  ...
  useEffect(() => {
    if (allServices.length > 0 && slug != service.id) {
      ...
      (loading || error) ? <div style={{ paddingTop: "50px", paddingBottom: "50px" }}> <Spinner /></div> : <><section
        ...
        style={{
          ...
          backgroundImage: `url(${service.img ?
            service.img.includes('http:') ? 'https:' + service.img.substr(5) : service.img : ''})`,
              ...
              >
                <div className="elementor-widget-container">
                  ...
                  <h1 className="elementor-heading-title elementor-size-default">
                    {service.id && service.title.split(":")[0]}
                  </h1>
                </div>
              </div>
              <section
                                                        ...
                                                        >
                                                            <Link to={""} role="btn">
                                                                ...
                                                                <span className="elementor-icon-list-text elementor-post-info__item elementor-post-info__item--type-date">
                                                                    {months[(new Date(service.createdAt)).getMonth()]} {(new Date(service.createdAt)).getDate()}, {(new Date(service.createdAt)).getFullYear()}{" "}
                                                                </span>
                                                            </Link>
                                                        </li>
                ...
                >
                  <div className="elementor-widget-container">
                    <img
                      ...
                      loading="lazy"
                      srcSet={service.img ?
                        (service.img.includes('http:') ? 'https:' + service.img.substr(5) : service.img + " 2000w") : ''}
